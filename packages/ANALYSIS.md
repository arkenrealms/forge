...
- Added `web/src/state/wallet/{README.md,ANALYSIS.md}` after source read of `wallet/hooks.ts`; documented multicall balance-hook ownership, amount-mapping behavior, and duplicate-address/test-coverage gaps.
